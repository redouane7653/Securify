...
//@Sql(scripts = "classpath:Client.sql", executionPhase = ExecutionPhase.BEFORE_TEST_METHOD)
...
public class ClientControllerTest {
	...
	private final Client TEST_CLIENT = new Client(null, 26, "Jordan Harrison");

	private final Client TEST_CLIENT = new Client("London", "05/07/1992", "Monday 16 from 07:00 to 19:00",
			"Musician@gmail.com", "Bond", "Mary", "Visa", 111111, 07654373);
	...
	public void testUpdate() throws Exception {
		final Client newClient = new Client(null, 26, "Chris Perrins");
