...
With this project i learnt to engineer JAVA applications that build relational and non relational databases capable of interacting with eachother with automated fashion  performing Create Read Update and Delete operations and testing with POSTMAN and Junit, what i wish to do in the near future is to go deeper in Integration Testing and further up the application to a more complex phase for future readiness of deployment in security industry  
